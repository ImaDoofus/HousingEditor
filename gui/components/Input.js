...
const cursorPositionField = GuiTextField.class.getDeclaredField('field_146224_r');
cursorPositionField.setAccessible(true);
const lineScrollOffsetField = GuiTextField.class.getDeclaredField('field_146225_q');
