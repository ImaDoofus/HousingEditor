...
register("guiRender", (x, y) => {
  ...
  input.setX(
    Renderer.screen.getWidth() / 2 - input.getWidth() + sizeDifference - margin
  );
...
register("guiClosed", (gui) => {
  if (gui.class.getName() !== "net.minecraft.client.gui.inventory.GuiChest")
    return;
  ...
  const inventoryTitleField =
    net.minecraft.inventory.InventoryBasic.class.getDeclaredField(
      "field_70483_a"
    );
